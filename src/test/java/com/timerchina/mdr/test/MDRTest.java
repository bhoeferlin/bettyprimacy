...
import com.timerchina.datarecordparser.NodeData;
import com.timerchina.datarecordparser.Tree;
...
//			db.prepareExecuteInsertReturnKey(insertSql, args);
			...
			long start = System.currentTimeMillis();
			com.timerchina.datarecordparser.MDR2 lp = new com.timerchina.datarecordparser.MDR2();
			String strAll = "";
...
//		System.out.println(content);
	...
	public void singleMultiTest(){
		...
		String content = page.getRawText();
//		System.out.println(content);
		com.timerchina.datarecordparser.MDR3 lp = new com.timerchina.datarecordparser.MDR3();
		String strAll = "";
